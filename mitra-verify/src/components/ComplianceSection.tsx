...
export default function ComplianceSection() {
  ...
  return (
    <section className="relative z-10 py-16 md:py-24 lg:py-32 bg-[#01081A] border-t border-white/[0.05] overflow-hidden">
      <div className="max-w-[1400px] w-full mx-auto px-4 sm:px-6 md:px-12">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-center">
          <motion.div 
            ...
            className="lg:w-1/3"
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4 md:mb-6 tracking-tight">Compliance & Privacy</h2>
            <p className="text-slate-400 text-[14px] md:text-[15px] leading-relaxed mb-6 md:mb-8">
          ...
          >
            {certs.map((c, i) => (
              <motion.div variants={itemVariants} key={i} className="flex gap-4 md:gap-5 p-5 sm:p-6 md:p-8 rounded-2xl bg-white/[0.02] border border-white/[0.05] hover:bg-white/[0.04] hover:border-white/[0.1] transition-all duration-300 group">

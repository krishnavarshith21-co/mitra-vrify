      ...
      <div style={{ maxWidth: 1280, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr 1fr', gap: 48, marginBottom: 64 }}>
          ...
          <div>
            ...
            <p style={{ fontSize: 14, color: 'var(--text-secondary)', lineHeight: 1.7, maxWidth: 300, marginBottom: 24 }}>
          ...
          {Object.entries(footerLinks).map(([section, links]) => (
            <div key={section}>
              <h4 style={{ fontSize: 12, fontWeight: 600, color: '#475569', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: 16 }}>
                {section}
              </h4>
                  ...
                  <li key={link.label}>
                    {'external' in link && link.external ? (
                      <a href={link.href} target="_blank" rel="noopener noreferrer"
                        style={{ display: 'flex', alignItems: 'center', gap: 4, fontSize: 14, color: '#94a3b8', textDecoration: 'none', transition: 'color 0.2s' }}
        ...
        {/* Bottom */}
        <div style={{ borderTop: '1px solid var(--border-subtle)', paddingTop: 32, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>

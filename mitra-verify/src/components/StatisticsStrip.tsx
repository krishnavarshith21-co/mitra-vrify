...
export default function StatisticsStrip() {
  return (
    <section className="relative z-10 py-16 bg-[#01081A] border-y border-white/[0.05]">
      <div className="max-w-[1400px] w-full mx-auto px-6 md:px-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-0 md:divide-x divide-white/[0.05]">
